<div align="center">
  <br />
    <a href="www.youtube.com/@Chanscoder" target="_blank">
  ...
  <h3 align="center">MyIphone 15 Website</h3>
...
👉 **Completely Mobile Responsive**: Consistent access and optimal viewing on any device with a fully responsive design that adapts to different screen sizes.
...
```bash
git clone https://github.com/shinanmohamed363/Sanan_Apple_clone.git
cd Sanan_Apple_clone
```
